...
Pod::Spec.new do |s|
  ...
  #                  DESC
  # s.homepage     = "http://EXAMPLE/KFURLBar"

  # Specify the license type. CocoaPods detects automatically the license file if it is named
  # 'LICENCE*.*' or 'LICENSE*.*', however if the name is different, specify it.
  s.license      = 'KF Propriatary Licence'
  ...
  # s.authors      = { "Rico Becker" => "rico.becker@kf-interactive.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Rico Becker', 'other author'

  # Specify the location from where the source should be retrieved.
  #
  s.source       = { :git => "https://kfi.codebasehq.com/kfurlbar/kfurlbar.git", :tag => "0.0.5" }
